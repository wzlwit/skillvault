...
description: Review security implications of code changes against a baseline. Use for security reviews of PRs, commits, uncommitted diffs, or removed validation; not for routine formatting or a claim of full-codebase audit coverage.
