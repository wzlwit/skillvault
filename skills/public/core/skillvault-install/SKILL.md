...
description: Install or update copies of existing SkillVault catalog skills in your environment, or browse the catalog. Does not edit repository source skills; use /sv-upsert for that. Use for /skillvault-install, /sv-install, /skv-install, "install skill", or "update installed skills".
metadata:
  author: wzlwit
  version: "1.1.0"
