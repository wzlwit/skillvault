...
description: List, enable, disable, or delete Windows scheduled tasks by index, list, range, or keyword. Triggers on "/schedule-manager", "schedule-manager", "list schedules", "list scheduled tasks", "enable scheduled task", "disable scheduled task", or "delete scheduled task".
metadata:
  author: wzlwit
  version: "1.1.0"
