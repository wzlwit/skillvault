...
Suggested scope: `global` for the reusable guide; an explicit project copy remains supported.
Each research task still needs a valid evaluator and licensed historical data in its selected
project. It installs no data provider, trading
