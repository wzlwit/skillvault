...
description: Design and validate REST API contracts. Use for OpenAPI or Swagger specifications, code-first API documentation, request and response schemas, contract drift, or SDK input specifications.
metadata:
  author: Seth Hobson
  maintainer: wzlwit
  version: null
